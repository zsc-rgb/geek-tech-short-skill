...
更快做出**能发的、专业向**竖屏技术短视频——冷黑硬核或暖纸社论，两套引擎按选题切换。

## 八项收益

1. **双模引擎** — Geek-Dark（冷黑）与 Warm Editorial（黑边 + 象牙卡）二选一，不混色板。
2. **频道级统一视觉** — 禁霓虹土味、全局运镜穿模、硬切；Editorial 保留 letterbox 呼吸感。
...
见仓库根目录 [README.md](../../README.md) 与 [PROMPT.md](PROMPT.md)。
